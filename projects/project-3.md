...
_Using PixiJS and/or the Browser DOM, create an Interactive Game or Rich Media "experience"_:
...
- **JavaScript & PixiJS** (which wraps WebGL):
  - [About this PixiJS Tutorial Series](../tutorial/pixi-js-0.md) has links to the **Circle Blast!** exercise and other demos that can get you started **OR**
- **JavaScript & the Browser DOM** - these exercises will give you an idea of what is possible, and also represent some nice "starter" code:
  ...
  - [DOM Adventure!](../tutorial/HW-adventure.md) is a tile-based game that uses arrow keys for movement, and simple sound.
  - [DOM Chibi Matching](../tutorial/HW-chibi-matching.md) is a card matching game that uses CSS animations.
  - [DOM Life](../tutorial/HW-life.md) is a tile-based game that explores simple [cellular automata](https://en.wikipedia.org/wiki/Cellular_automaton).
  - [Magentic Poetry](../tutorial/HW-magnetic-poetry.md) uses CSS transforms and absolute positioning, and mousemove events.
...
- Separation of Concerns. Similar to how the _Circle Blast!_ HW was structured, have a separate .js file for your classes, utility functions, and main code. If you have more than 3 CSS rules, then put them in an external stylesheet

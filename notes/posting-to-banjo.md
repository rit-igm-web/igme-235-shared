...
1. Be sure to confirm that your files have been properly posted by pointing a browser at `https://people.rit.edu/abc1234` - note that the `www` folder is NOT in the URL after your username. Alternatively, a `~` can be placed before your username like: `https://people.rit.edu/~abc1234`
